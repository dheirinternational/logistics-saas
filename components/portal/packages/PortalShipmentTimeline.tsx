      ...
      {isOpen && (
        ...
        >
          {events.map((event, idx) => {
            ...
            return (
              <div key={idx} style={{ display: "flex", gap: 16, position: "relative", minHeight: 56 }}>
                {/* Left Column: Date & Time */}
                <div style={{ width: 80, textAlign: "right", display: "flex", flexDirection: "column", gap: 2, paddingRight: 4 }}>
                  {isActive && (
                    <>
                      <span style={{ fontSize: "10px", color: "var(--color-dheir-muted)" }}>
                        {event.dateLabel}
                      </span>
