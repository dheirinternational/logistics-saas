      ...
      <div className="marketing-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          {options.map((opt) => {
            const Icon = opt.icon
            return (
              <div key={opt.title} className="flex flex-col justify-between gap-6 p-8 rounded-2xl bg-dheir-surface">
                ...
                <Link
                  href={opt.href}
                  className="inline-flex items-center gap-2 text-xs font-bold text-dheir-blue hover:text-dheir-blue-hover transition-colors"
                >
                  {opt.cta}
