    ...
    <section id="procurement-sourcing" className="marketing-section py-16 md:py-24 bg-dheir-surface">
      <div className="marketing-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Card 1: Sourcing */}
          <div className="flex flex-col gap-6 p-8 rounded-2xl bg-dheir-page">
            ...
            <p className="text-xs leading-relaxed text-dheir-muted pt-4 border-t border-dheir-border/50">
