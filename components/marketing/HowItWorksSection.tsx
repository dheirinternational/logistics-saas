...
function StepCard({
  ...
  return (
    <article className="how-it-works-card flex h-[min(80vh,580px)] min-h-[460px] w-[min(82vw,300px)] shrink-0 flex-col overflow-hidden rounded-2xl bg-dheir-surface shadow-[var(--shadow-dheir-soft)] sm:w-[300px] md:h-[560px] md:w-auto">
      <div className="relative min-h-[260px] flex-[1.6] md:min-h-[300px]">
        <Image
          src={imageSrc}
          alt={imageAlt}
          fill
        ...
        />
        <div
          className="absolute inset-0 bg-gradient-to-t from-dheir-ink/35 via-transparent to-transparent"
          aria-hidden
        />
