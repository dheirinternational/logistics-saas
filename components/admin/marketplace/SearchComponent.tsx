...
const SearchComponent = () => {
    ...
    const [filterParams, setFilterParams] = useState<FilterParams>({search: "", status: "", category: ""})
  ...
  return (
    <form onSubmit={handleSubmit} className='p-body px-8 bg-light rounded-lg flex flex-col gap-4'>
        ...
        <InputComponent name="category" title="Category" type="text" state={filterParams} setState={setFilterParams}/>
